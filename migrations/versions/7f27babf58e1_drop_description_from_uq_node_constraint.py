...
def upgrade():
    ...
    with op.batch_alter_table('node', schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint('uq_node', ['name', 'section', 'subsection', 'version', 'section_id'])
...
def downgrade():
    ...
    with op.batch_alter_table('node', schema=None) as batch_op:
        batch_op.drop_constraint('uq_node', type_='unique')
        batch_op.create_unique_constraint('uq_node', ['name', 'section', 'subsection', 'ntype', 'description', 'version', 'section_id'])
