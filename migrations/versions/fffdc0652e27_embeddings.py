...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['cre_id'], ['cre.id'], name=op.f('fk_embeddings_cre_id_cre'), onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['node_id'], ['node.id'], name=op.f('fk_embeddings_node_id_node'), onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('embeddings', 'doc_type', 'cre_id', 'node_id', name='uq_entry')
    )
