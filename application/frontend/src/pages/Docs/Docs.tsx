        ...
        <section id="getting-started" className="docs-section">
          ...
          <div className="docs-section__body">
            <p>
              ...
              homepage search, <a href="/root_cres">Browse</a>, <a href="/map_analysis">Map Analysis</a>, or
              the <a href="/chatbot">Chat</a> assistant to explore mapped content.
            </p>
            <p>
              Integrators can use the read-only REST API under <code>{apiUrl}</code>. The OpenAPI
              specification is generated from the backend route registry and validated in CI.
            </p>
          </div>
        </section>
