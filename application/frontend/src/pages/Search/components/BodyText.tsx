  ...
  return (
    <div className="index-text">
      ...
      <p>
        ...
        section to also link with all other resources that map to the same topic. This 1) enables users to
      ...
      <p>
        ...
        sheets, Testing guide), plus several other sources (CWE, NIST-800 53, NIST-800 63b), as part of the
      ...
      <p>
        ...
        <a href="https://www.youtube.com/watch?v=4-HTa1pTEVI&list=PLpr-xdpM8wG8CX91aE_LV3OxmtT9lvUW5&index=92">
          {' '}
          presentation video
        </a>
        , or read the
