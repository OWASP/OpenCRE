...
export const SearchBody = () => {
  return (
    <div className="index-text">
      ...
      <p>
        <strong>
          The OWASP Open Source project “OpenCRE “ links all security standards and guidelines together at the
          level of requirements into one harmonized resource: threats, weaknesses, what to verify, how to
          program, how to test, which tool settings, in-depth discussion, training material. Everything
          organized.
        </strong>
      </p>
      ...
      <p>
        <ul>
          ...
          <li>
            <a href="/cre/581-525">CRE 581-525</a>
          </li>
          <li>
            <a href="/chatbot">OpenCRE Chat</a> to ask any security question. In collaboration with Google, we
            injected all the standards in OpenCRE into an AI model to create the world's first
            security-specialized chatbot. It provides a more reliable answer, and also a reference to the
            relevant standard text.
          </li>
          <li>
            <a href="/map_analysis">Map Analysis</a> to find how any two standards connect with eachother
          </li>
          <li>
          ...
          <li>
            <a href="/root_cres">Browse</a> to explore our catalog (semantic web) of common requirements
            across development processes, technical controls, etc.
          </li>
          <li>
      ...
      <h2>How it works:</h2>
      <p>
        OpenCRE links each section of a resource to the corresponding’Common Requirement’, causing that
        section to also link with all other resources that link to the same requirement. This 1) enables users
