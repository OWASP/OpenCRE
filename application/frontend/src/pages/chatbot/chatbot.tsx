            ...
            <Grid>
              ...
              <div className="chatbot">
                <i>
                  ...
                  <br/><br/>
                  Privacy & Security: Your question is sent to Heroku, the hosting provider for OpenCRE, and then to GCP, all via protected connections. 
                  Your data isn't stored on OpenCRE servers. The OpenCRE team employed extensive measures to ensure your privacy and security. 
                  To review the code, visit: https://github.com/owasp/OpenCRE
                </i>
              </div>
            </Grid>
          </Container>
