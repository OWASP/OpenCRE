          ...
          <Container>
            <Grid>
              ...
              <div className="chatbot">
                <i>
                  Answers are generated by a Google PALM2 Large Language Model, which uses the internet as training data, 
                  plus collected key cybersecurity standards from <a href="https://opencre.org">OpenCRE</a> as the preferred source. 
                  This leads to more reliable answers and adds references, but note: it is still generative AI which is never guaranteed correct.
                </i>
              </div>
              <div className="chatbot">
                <i>
                  Model operations are generously funded by <a href="https://www.softwareimprovementgroup.com">Software Improvement Group</a>.
                </i>
              </div>
              <div className="chatbot">
                <i>
                  Privacy & Security measures:<br/>
                  -Your question is sent to Heroku, the hosting provider for OpenCRE, and then to GCP, all via protected connections<br/>
                  -Your data isn't stored on OpenCRE servers<br/>
                  -The OpenCRE team is committed to safeguarding your privacy and security. We've employed extensive measures to ensure this<br/>
                  -To review our code, visit: https://github.com/owasp/OpenCRE
                </i>
              </div>
            </Grid>
          </Container>
