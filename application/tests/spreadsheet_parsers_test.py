...
from application.utils.spreadsheet_parsers import (
    parse_export_format, parse_hierarchical_export_format,
    parse_uknown_key_val_standards_spreadsheet, parse_v0_standards,
    parse_v1_standards)
...
class TestParsers(unittest.TestCase):
    ...
    def test_parse_hierarchical_export_format(self) -> None:
        ...
        sOPC = defs.Standard(
            name="OWASP Proactive Controls", section="123654", hyperlink="https://example.com/opc"
        )
        sCWE19876 = defs.Standard(
            name="CWE", section="19876", hyperlink="https://example.com/cwe19876"
        )
        sWSTG = defs.Standard(
            name="(WSTG) Web Security Testing Guide", section="2.1.2.3", hyperlink="https://example.com/wstg"
        )
